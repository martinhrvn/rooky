...
export const kingLevels: readonly LevelData[] = [
...

  {
    ...
    world: 'king',
    tier: 1,
    teaches: 'One star in the far corner: diagonal steps are the short way across the board',
    // Four moves for four squares of distance, where going along and then up
    // would cost eight. The king's diagonal is worth as much as anyone's.
    fen: '8/8/8/8/4K3/8/8/8 w - -',
    stars: 'a8',
    goal: 'collectAllStars',
    par: 4,
  },
  {
    ...
    world: 'king',
    tier: 1,
    teaches: 'The near star on the way out is free; going back for it afterwards costs a move',
    fen: '8/8/8/8/8/8/8/4K3 w - -',
    stars: 'd2 g3',
    goal: 'collectAllStars',
    par: 4,
  },
  {
    ...
    world: 'king',
    tier: 1,
    teaches: 'A staircase: three diagonal steps, one after another, in the same direction',
    fen: '8/8/8/8/8/8/1K6/8 w - -',
    stars: 'c3 d4 e5',
    goal: 'collectAllStars',
    par: 3,
  },
  {
    ...
    world: 'king',
    tier: 1,
    teaches: 'A ring around the square he starts on — walk it one way and nothing is wasted',
    fen: '8/8/8/8/8/8/8/2K5 w - -',
    stars: 'b2 c2 d2 d1 b1',
    goal: 'collectAllStars',
    par: 5,
  },
  ...
  },
  {
    ...
    world: 'king',
    tier: 2,
    teaches: 'Two pawns cover four squares between them, so the king has to come from above',
    fen: '8/8/8/3pp3/8/4K3/8/8 w - -',
    goal: 'captureAll',
    par: 5,
  },
  {
    ...
    world: 'king',
    tier: 2,
    teaches: 'A knight between the two pawns: the gap in the middle is the one square to avoid',
    fen: '8/8/8/2p2p2/4n3/8/4K3/8 w - -',
    goal: 'captureAll',
    par: 6,
  },
  {
    ...
    world: 'king',
    tier: 2,
    teaches: 'Two pawns side by side and the king below them — the way in is round the outside',
    fen: '8/8/8/8/2pp4/8/1K6/8 w - -',
    goal: 'captureAll',
    par: 4,
  },
  {
    ...
    world: 'king',
    tier: 2,
    teaches: 'A gap between the pawns that both of them cover — go up the far side instead',
    fen: '8/8/8/1p1p4/8/2K5/8/8 w - -',
    goal: 'captureAll',
    par: 4,
  },
  {
    ...
    world: 'king',
    tier: 2,
    teaches: 'The knight first and the pawns after, with a walk between each of them',
    fen: '8/8/2p1p3/8/3n4/8/3K4/8 w - -',
    goal: 'captureAll',
    par: 6,
  },
];
